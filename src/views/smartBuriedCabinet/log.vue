<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column property="voltage" align="center" label="电量(%)" sortable />
      <el-table-column property="temperature" align="center" label="温度(℃)" sortable />
      <el-table-column property="sign" align="center" label="信号值(dbm)" sortable />
      <el-table-column property="humi" align="center" label="湿度(%)" sortable />
...
<script>
import { getPageTraceLogList, getTraceLogList, handleDownload } from '@/api/TraceLog'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getPageTraceLogList(this.listCondition).then(res => {
    ...
    traceLogExport() {
      ...
      getTraceLogList(this.listCondition).then(res => {
