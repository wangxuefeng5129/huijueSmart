<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column property="sysUserName" align="center" label="系统操作用户" sortable />
      <el-table-column property="phone" align="center" label="手机号" sortable />
...
<script>
import { getOnuListHistory, handleDownload } from '@/api/onuHistory'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getOnuListHistory(this.listCondition).then(res => {
